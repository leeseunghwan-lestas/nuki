const translations = {
  en: {
    ...
    'popup.clearHistoryAria': 'Clear all clipboard history',
    ...
    'popup.save': 'Save',
    'popup.cancel': 'Cancel',
    'popup.editAriaLabel': 'Edit extracted text',
    'popup.cardAriaLabel': 'Click to copy, or use action buttons to edit or delete',
    ...
    'welcome.skipTutorial': 'Skip tutorial',
  ...
  ja: {
    ...
    'popup.clearHistoryAria': 'クリップボード履歴をすべて削除',
    ...
    'popup.save': '保存',
    'popup.cancel': 'キャンセル',
    'popup.editAriaLabel': '抽出されたテキストを編集',
    'popup.cardAriaLabel': 'クリックでコピー、ボタンで編集または削除',
    ...
    'welcome.skipTutorial': 'チュートリアルをスキップ',
